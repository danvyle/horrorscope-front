...
class Capricorn extends React.Component {
  ...
  componentDidMount() {
    fetch('https://horrorscope-backend.herokuapp.com/signs/1')
    .then(resp => resp.json())
        ...
        <div className ="App">
          <header className="App-header">
            <div className= 'horoscope-display'>
              <div onClick = {this.handleClickHome} className="horoscope-img"> <h3 className='item'>HOME</h3> <img src = {capimg}/>  </div>
